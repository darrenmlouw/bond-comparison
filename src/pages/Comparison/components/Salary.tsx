    ...
    <div>
      ...
      <form className="flex flex-col space-y-4">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="flex flex-col space-y-6 bg-card opacity-75 outline outline-1 outline-slate-700 shadow-2xl p-4 rounded-xl max-h-full content-between w-full md:w-2/3 justify-between">
