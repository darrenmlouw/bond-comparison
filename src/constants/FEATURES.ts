...
const FEATURES: Feature[] = [
  {
    ...
    boxShadow: "0 4px 15px 3px rgba(59, 130, 246, 0.6), 0 0 20px 5px rgba(127, 0, 255, 0.5)", // Blue and violet glow
  },
  {
    id: 2,
    ...
    boxShadow: "0 4px 15px 3px rgba(127, 0, 255, 0.6), 0 0 20px 5px rgba(225, 0, 255, 0.5)", // Violet and pink glow
  },
  {
    id: 3,
    ...
    boxShadow: "0 4px 15px 3px rgba(225, 0, 255, 0.6), 0 0 20px 5px rgba(255, 106, 0, 0.5)", // Pink and red-orange glow
  },
];
