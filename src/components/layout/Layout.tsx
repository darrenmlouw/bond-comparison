...
const Layout = () => {
  ...
  return (
    <>
      ...
      <Analytics />
      <SpeedInsights />
      <div className="z-20 fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-primary/20 backdrop-blur-[6px] outline outline-1 outline-foreground/30 rounded-full">
        <FloatingDock
          items={dockItems}
