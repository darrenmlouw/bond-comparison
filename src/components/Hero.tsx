...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col text-center h-full w-full outline outline-4 -outline-offset-4 dark:outline-white/70 outline-white/90 rounded-3xl sm:rounded-3xl md:rounded-3xl justify-center items-center">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-24 text-foreground/60 mx-6">
          Make the Right Choice
        </h1>

        <p className="text-foreground/60 text-md sm:text-lg md:text-xl mb-16 mx-6">
        ...
        <Button
          ...
          className="tracking-widest font-light text-foreground/75 hover:text-foreground font text-xl shadow-neumorphism-sm bg-background outline-none transition-transform duration-200  hover:scale-110 hover:shadow-neumorphism-md active:bg-foreground/10 hover:bg-background/90 active:outline-none"
        >
          Get Started
        </Button>
      </div>
