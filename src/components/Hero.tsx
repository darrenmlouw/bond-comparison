...
const Hero = () => {
  ...
  return (
    <section id="hero" className="h-screen flex items-center justify-center p-6 sm:p-9 md:p-12">
      <div className="flex flex-col text-center px-6 h-full w-full  outline outline-4 -outline-offset-4 outline-white/70 rounded-3xl sm:rounded-3xl md:rounded-3xl justify-center items-center">
