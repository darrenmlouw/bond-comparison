        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/4 flex justify-center mb-4 md:mb-0">
              <FaClipboardList className="text-4xl sm:text-5xl md:text-6xl text-violet-500" />
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/4 flex justify-center mb-4 md:mb-0">
              <FaInfoCircle className="text-4xl sm:text-5xl md:text-6xl text-pink-500" />
            </div>
            <div className="md:w-3/4 text-center md:text-left">
              <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/4 flex justify-center mb-4 md:mb-0">
              <FaEdit className="text-4xl sm:text-5xl md:text-6xl text-green-500" />
            </div>
            <div className="md:w-3/4 text-center md:text-left">
              <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/4 flex justify-center mb-4 md:mb-0">
              <FaChartPie className="text-4xl sm:text-5xl md:text-6xl text-yellow-500" />
            </div>
            <div className="md:w-3/4 text-center md:text-left">
              <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mb-2">4. View Analytics</h3>
              <p className="text-base text-neutral-600 dark:text-neutral-400">
